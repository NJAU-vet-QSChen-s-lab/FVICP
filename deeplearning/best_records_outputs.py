...
# 使用配置文件中的路径
folders = [
    os.path.join(TRAIN_DIR, 'fascia_CPTC'),
    os.path.join(TRAIN_DIR, 'fascia_FC'),
    os.path.join(TRAIN_DIR, 'fascia_EC'),
    os.path.join(TRAIN_DIR, 'fascia_ETC'),
    os.path.join(TRAIN_DIR, 'fascia_MC'),
    os.path.join(TRAIN_DIR, 'fascia_MuC'),
    os.path.join(TRAIN_DIR, 'fascia_MuSC'),
    os.path.join(TRAIN_DIR, 'fascia_LP'),
    os.path.join(TRAIN_DIR, 'fascia_Others')
]
